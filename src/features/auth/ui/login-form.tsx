...
import { useLoginForm } from '@/features/auth/viewmodel/use-login-form'
  ...
  return (
    <form onSubmit={submit} noValidate className="flex flex-col">
      ...
      <div className="mt-3 text-right">
        <button
          type="button"
          onClick={() => notImplementedToast('Recuperação de senha')}
      ...
      <div className="flex flex-col gap-3">
        <button
          type="button"
          onClick={() => notImplementedToast('Login com Google')}
        ...
        <button
          type="button"
          onClick={() => notImplementedToast('Login com Facebook')}
          className="flex h-10 w-full items-center justify-center gap-2 rounded-[5px] border border-[#3F2319] text-sm text-foreground"
        >
